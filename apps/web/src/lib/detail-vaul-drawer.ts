...
export const MOVIE_DETAIL_DRAWER_SCROLL_CLASSNAME =
	"w-full min-h-0 flex-1 touch-pan-y contain-[paint] overflow-y-auto overscroll-contain px-5 pt-2 pb-10 [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch] scrollbar-none sm:px-8 sm:pb-12";
