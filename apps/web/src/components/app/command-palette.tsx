			...
			{isOpen ? (
				...
				>
					<motion.div
						...
						/* Track B: palette sits on `surface-overlay` — one step above raised cards so ⌘K reads as top-layer UI. */
						className="mx-auto mt-[12vh] w-[92vw] max-w-xl overflow-hidden rounded-2xl border border-white/7 bg-surface-overlay shadow-[0_24px_80px_rgba(5,5,8,0.55)]"
					>
						<Command
							label="Search"
							/**
...
function CommandItem({
	...
	return (
		<Command.Item
			onSelect={onSelect}
			className={cn(
				"group flex cursor-pointer items-center gap-3 rounded-md px-2 py-2 text-foreground text-sm",
