...
export function MarqueeBanner({ className }: { className?: string }) {
	return (
		<div
			className={cn(
				"-mx-4 mb-10 rounded-none border-0 bg-transparent px-0 py-2.5 font-semibold text-[10px] text-muted-foreground uppercase tracking-[0.28em] shadow-none outline-none ring-0 sm:-mx-6 lg:-mx-8 xl:-mx-12 2xl:-mx-16",
				className,
			)}
			aria-hidden
		>
