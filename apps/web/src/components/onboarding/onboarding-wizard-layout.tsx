	...
	return (
		...
		>
			<div className="mx-auto flex min-h-0 w-full flex-1 flex-col overflow-hidden rounded-3xl bg-card lg:flex-row lg:gap-10 lg:px-8 lg:py-5">
				<div className="flex min-h-0 flex-1 flex-col items-center justify-start overflow-y-auto overscroll-contain px-4 py-8 lg:max-w-none lg:shrink-0 lg:justify-center lg:px-0 lg:py-6">
					{previewStrip ? (
