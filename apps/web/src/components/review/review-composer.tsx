		...
		<AnimatePresence>
			{isOpen ? (
				...
				>
					...
					>
						<header className="flex items-start justify-between border-border border-b p-4">
							<div>
						...
						<div className="space-y-4 p-4">
							...
							<label className="flex select-none items-center gap-2 text-muted-foreground text-sm">
								<input
									type="checkbox"
									checked={contains}
						...
						<footer className="flex items-center justify-end gap-2 border-border border-t p-4">
